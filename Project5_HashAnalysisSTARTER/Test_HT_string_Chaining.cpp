...
//****************Testing HashTable<string> with Chaining*****************
...
//****************Testing HashTable<string> with Chaining ***************
{
	...
	//Test Chaining with vector of HashTableChaining<unsigned>
	cout << "****Starting analysis of HashTable<string> using Chaining****" << endl;
	htAnalysisFile << "****Starting analysis of HashTable<string> using Chaining****" << endl;
	...
	htAnalysisFile << "HT<string> Chaining Initial Insertion of strings:\n";
	...
	htAnalysisFile << "HT<string> Chaining Successful 'Contains' Probes Totals:\n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << i << "\t\t";
	}
	htAnalysisFile << endl;
	...
	htAnalysisFile << endl;
	htAnalysisFile << "HT<string> Chaining Average Successful 'Contains': \n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << resultSuccessContainsTotalProbes[i] / static_cast<double>(successfulTotal[i]) << "\t";
	}
	htAnalysisFile << endl;
	htAnalysisFile << "HT<string> Chaining  Unsuccessful 'Contains' Probe Totals: \n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << i << "\t\t";
	}
	htAnalysisFile << endl;
	...
	htAnalysisFile << endl;
	htAnalysisFile << "HT<string> Chaining Average Unsuccessful Contains: \n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << resultUnSuccessContainsTotalProbes[i] / static_cast<double>(unsuccessfulTotal[i]) << "\t";
	}
	htAnalysisFile << endl;
	htAnalysisFile << "****Finished analysis of HashTable<string> using Chaining****" << endl;
	cout << "****Finished analysis of HashTable<string> using Chaining****" << endl;
	htAnalysisFile << endl;
}
