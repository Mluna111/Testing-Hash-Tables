...
//****************Testing HashTable with Chaining  using unsigned keys*****************
{
	...
	cout << "****Starting analysis of HashTable<unsigned> using Chaining ****" << endl;
	htAnalysisFile << "****Starting analysis of HashTable<unsigned> using Chaining ****" << endl;
	unsigned tableNum;
	...
	htAnalysisFile << "Chaining Initial Insertion Results:\n";
	...
	htAnalysisFile << "Chaining Successful Contains Results:\n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << i << "\t\t";
	}
	htAnalysisFile << endl;
	...
	htAnalysisFile << "Chaining Unsuccessful Contains Results:\n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << i << "\t\t";
	}
	htAnalysisFile << endl;
	...
	htAnalysisFile << endl;
	cout << "****Finished analysis of HashTable<unsigned> using Chaining ****" << endl;
	htAnalysisFile << "****Finished analysis of HashTable<unsigned> using Chaining ****" << endl;
	htAnalysisFile << endl;
}